...
text_treat_full <- text_treat_full |> 
  select(st_id, text)
...
text_control_full <- text_control_full |> 
  select(st_id, text)
...
par(mfrow = c(2,1))
hist(tidy_treat_sentiment$sentiment, breaks = seq(-10, 40, 1), main = "Sentiment among affirmed students")
hist(tidy_control_sentiment$sentiment, breaks = seq(-10, 40, 1), main = "Sentiment among control students")
...
*Treated students*: 10.4 (19.6%) interdependent words, 2.78 (5.2%) independent words; out of 53 non-stop-word words

*Control students*: 5.63 (16.1%) interdependent words, 1.59 (4.5%) independent words; out of 35 non-stop-word words
