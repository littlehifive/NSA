...
```{r}
#load("/Users/michaelfive/Library/CloudStorage/GoogleDrive-wuzezhen33@gmail.com/My Drive/Nepal SA Study/Analysis/model/gr6-10_survey_gpa_0917.RData")
```
...
```{r}
fit_gpa_treated <- brm(
    all_gpa_e ~ all_gpa_b + treated_int + ind_count_int + inter_count_int + total_count_int +
